...
func (_m *Collection) Aggregate(_a0 context.Context, _a1 interface{}) (database.Cursor, error) {
...
func (_m *Collection) Find(_a0 context.Context, _a1 interface{}, _a2 ...*options.FindOptions) (database.Cursor, error) {
	_va := make([]interface{}, len(_a2))
	for _i := range _a2 {
		_va[_i] = _a2[_i]
	}
